...
BOOL InjectDLL(DWORD ProcessID) {
  LPCSTR DLL_PATH = "E:\\Videos\\11 dll injector\\vs "
                    "Project\\DllInjector\\Debug\\Terraria_dll.dll";
  ...
  RemoteString = (LPVOID)VirtualAllocEx(Proc, NULL, strlen(DLL_PATH) + 1,
                                        MEM_COMMIT, PAGE_READWRITE);
  WriteProcessMemory(Proc, RemoteString, (LPVOID)DLL_PATH, strlen(DLL_PATH) + 1,
                     NULL);
